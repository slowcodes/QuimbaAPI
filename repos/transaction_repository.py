...
from commands.transaction import TransactionDTO
from models.auth import User
from models.client import Person, Client
from models.services import ServiceBooking, BookingStatus
...
class TransactionRepository:
    ...
    def get_transactions(self, limit, skip, lab_id,
                         ...
                         client_id: int, date_filter:
                         DateFilterDTO, booking_id: int = 0,
                         ):
    ...
    def get_laboratory_transaction(self, transaction_id):
        ...
        lab = LabRepository(self.db_session)
                ...
                transaction.append(
                    {
                        ...
                        'details':self.get_laboratory_transaction(txn.id)
                    }
                )
