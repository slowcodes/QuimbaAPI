...
Revision ID: 41fc5aed1760
Revises: 019ae5dc9ee8
Create Date: 2025-09-10 20:05:34.907918
...
revision: str = '41fc5aed1760'
down_revision: Union[str, None] = '019ae5dc9ee8'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_client_referral_id', table_name='client_referral')
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('lab_service_group_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('deleted_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('is_deleted', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('title', postgresql.ENUM('Mr', 'Mrs', 'Ms', 'Dr', 'Prof', 'Chief', 'Scientist', name='proftitle'), server_default=sa.text("'Mr'::proftitle"), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('referred_transaction_settlement_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('lab_experiment_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('sample_type', postgresql.ENUM('Whole_Blood', 'Serum', 'Plasma', 'Capillary_Blood', 'Random_Urine', 'First_Morning_Urine', 'Timed_Urine', 'Catheterized_Urine', 'Stool', 'Throat_Swabs', 'Nasal_Nasopharyngeal_Swabs', 'Wound_Swabs', 'Urogenital_Swabs', 'Cerebrospinal_Fluid', 'Pleural_Fluid', 'Peritoneal_Fluid', 'Pericardial_Fluid', 'Synovial_Fluid', 'Bronchoalveolar_Lavage', 'biopsy', 'Sputum', 'Hair', 'Nail', 'Amniotic_Fluid', 'Saliva', 'Semen', 'Tissue', 'Bone_Marrow', 'Breast_Milk', name='sampletype'), autoincrement=False, nullable=True),
    ...
    sa.Column('parameter_type', postgresql.ENUM('Number', 'Ratio', 'Description', 'Exclusive_Options', 'Inclusive_Options', name='parametertype'), autoincrement=False, nullable=True),
